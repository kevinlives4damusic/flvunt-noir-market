  ...
  return (
    <>
      <div className="group relative">
        ...
        <Link to={`/product/${id}`} className="block">
          <div className="aspect-square overflow-hidden bg-flvunt-lightgrey mb-3 relative rounded-xl border border-white/20 shadow-md">
            ...
            <div className="absolute inset-0 transition-opacity duration-300 flex items-end justify-center opacity-0 group-hover:opacity-100">
              ...
              <div className="relative flex gap-2 mb-6 transform translate-y-4 group-hover:translate-y-0 transition-transform duration-300" onClick={(e) => e.preventDefault()}>
                <Button 
        ...
        {/* Product info */}
        <Link to={`/product/${id}`} className="block">
          <div className="rounded-xl border border-white/20 bg-white/60 backdrop-blur-md p-3 shadow-sm hover:bg-white/80 transition-colors">
